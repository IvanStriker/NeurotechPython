...
class Currency(BaseModel):
    ...
    @check_types(Any, str, int, str, str, float | int, int)
    def __init__(self, id: str, num_code: int,
        ...
        Args:
            id (str): Unique identifier from BaseModel.
            num_code (int): Numeric code of the currency
    ...
    def num_code(self) -> int:
        ...
        Returns:
            int: The numeric code of the currency (ISO 4217).
        """
    ...
    def num_code(self, num_code: int) -> None:
        ...
        Args:
            num_code (int): The new numeric code for the currency.
        """
